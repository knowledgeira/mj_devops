...
echo -e " 1. Install Vagrant,Virtualbox and 2 vm's and MJ_autoinstall script"
echo -e " 2. Install Only Devops packages \n"


read -p "Choose any one option from from above :  " RESP

echo -e "\n===============================================\n"
case $RESP in 
	"1" ) echo "You choose option 1"
	sudo apt update	>>/dev/null 2>&1

   	echo -e Step1 : "We are first going to update\n\n"
	echo "update completed"
	echo -e "\n\n=====================Finished update===================================\n\n"
	sleep 5
	
   	echo -e "Step2 : Installing vagrant and vbox directly from available repos\n\n"
   	echo -e "If this is for first time of installation, it will take around 10-15 minutes.\n\n"
	sudo apt-get install virtualbox -y >>/dev/null 2>&1
	sudo apt-get install vagrant -y >>/dev/null 2>&1
	echo -e "\n\n Finished installing Vagrant and Virtual box, now starting vagrant boxes "
	sleep 5
echo -e "\n===============================================\n"
	...
	echo -e "We will be installing required devops packages \n "
sleep 10

	break
	;;

	* ) echo "Quitting the script,please respond with either 1 or 2"	
	exit
	;;
esac


   	echo -e "Step3 : Installing vagrant and vbox directly from available repos\n\n"
echo -e "\n\n Starting mj_autoinstall.sh==========================================\n\n"
sleep 5
